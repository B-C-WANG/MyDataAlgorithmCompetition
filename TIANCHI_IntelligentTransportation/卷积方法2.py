...
def train2(train=True,load_weights=True,save_weights=True,
           predict=False,valid=False,epoch=500,per_epoch=500):
    ...
    def myloss(y_true,y_pred):
        ...
        #
        return (loss*0.5+loss_2*0.5)*100
...
#train2(train=True,valid=True,save_weights=True,
# epoch=50,load_weights=True,per_epoch=500)


train2(train=True,valid=True,save_weights=True,epoch=10,load_weights=True,per_epoch=2)
